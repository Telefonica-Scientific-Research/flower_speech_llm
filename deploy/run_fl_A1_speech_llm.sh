#!/bin/bash
#SBATCH --job-name=fl_A1_speech_llm
#SBATCH --output=./slurm_logs/fl_A1_speech_llm_%j.out
#SBATCH --error=./slurm_logs/fl_A1_speech_llm_%j.err
...
echo "FL Experiment A1: IID mixed + FedAvg"
echo "=========================================="
